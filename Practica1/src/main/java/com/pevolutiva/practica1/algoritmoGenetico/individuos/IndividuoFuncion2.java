...
public class IndividuoFuncion2 extends Individuo<Boolean> {
	...
	private Integer bin2dec(Boolean[] list, int range1, int range2) { // Convierte de binario a decimal para traducir de
																		// genotipo a fenotipo
		Integer result = 0;
	...
	public String toString() { // Printea las caracteristicas del individuo
		/*
		 * return "max: " + Arrays.toString(max) + " min: " + Arrays.toString(min) +
		 * " cromosoma: " + Arrays.toString(cromosoma) + " precision: " + precision +
		 * " tamGenes: " + Arrays.toString(tamGenes) ;
		 */
		return "Valor: " + -getValor() + " Fenotipo1: " + getFenotipo(0) + " Fenotipo2: " + getFenotipo(1);
	}
